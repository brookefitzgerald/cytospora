...
plot_stochastic_dom(7, 2)
plot_stochastic_dom(1, 2)
plot_stochastic_dom(3, 2)
plot_stochastic_dom(9, 2)
plot_stochastic_dom(4, 2)
plot_stochastic_dom(5, 2)
plot_stochastic_dom(6, 2)
plot_stochastic_dom(8, 2)
